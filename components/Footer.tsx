    ...
    return (
        <footer className="fixed bottom-0 left-0 w-full bg-white text-gray-900 py-3 flex justify-around items-center border-t border-gray-300 z-50">
            <button className="flex flex-col items-center gap-1" onClick={() => router.push("/learn")}>
                <Image src="https://d16ho1g3lqitul.cloudfront.net/learn.svg" alt="Home" width={38} height={38} className="w-10 h-10" />
            </button>
            <button className="flex flex-col items-center gap-1" onClick={() => router.push("/leaderboard")}>
                <Image src="https://d16ho1g3lqitul.cloudfront.net/leaderboard.svg" alt="Courses" width={38} height={38} className="w-10 h-10" />
            </button>
            <button className="flex flex-col items-center gap-1" onClick={() => router.push("/quests")}>
                <Image src="https://d16ho1g3lqitul.cloudfront.net/quests.svg" alt="Achievements" width={38} height={38} className="w-10 h-10" />
            </button>
            <button className="flex flex-col items-center gap-1" onClick={() => router.push("/shop")}>
                <Image src="https://d16ho1g3lqitul.cloudfront.net/shop.svg" alt="Profile" width={38} height={38} className="w-10 h-10" />
            </button>
        </footer>
    );
};
